...
namespace ZargoEngine
{
    public abstract class MonoBehaviour
    {
        ...
        public void OnGUI()
        {
            ...
            ImGui.TextColored(Color4.Yellow.ToSystem(),name);
                        ...
                        case SliderAttribute sliderAttribute:
                            switch (value)
                            {
                                case float val:
                                    ...
                                    break;
                                case int intVal:
                                    ImGui.SliderInt(field.Name, ref intVal, (int)sliderAttribute.min, (int)sliderAttribute.max, sliderAttribute.format, sliderAttribute.imGuiSliderFlags);
                                    field.SetValue(this, intVal);
                                    break;
                                case Vector2 vector2:
                                    System.Numerics.Vector2 vec2Val = vector2.ToSystem();
